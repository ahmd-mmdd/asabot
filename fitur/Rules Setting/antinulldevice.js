...
async function message(sock, m, store) {
    ...
    if(g.antinulldevice){
        await g.put("antinulldevice",0);
        nyarios("antinulldevice berhasil di matikan");
    }else{
        await g.put("antinulldevice",1);
        nyarios("antinulldevice berhasil di aktifkan");
    }
