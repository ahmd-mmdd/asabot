...
async function message(sock, m, store) {
    ...
    if(!isset(sock.game[id])){
        const {data: {Barqah: {unsur:soal,lambang:jawaban,alasan}}} = await sock.sendRequest(m).get(`${baseURL}/api/minigame/tebakkimia?apikey=${config.apikey}`)
